...
try:
    ...
    from data.data_util import imresize_np
except ImportError:
    pass
...
def generate_mod_LR_bic():
    ...
    mod_scale = 8
    # set data dir
    sourcedir = 'F:\CVPR\PIPAL_288x288\Reference_overall\overview&ori\Ori\\'
    savedir = 'F:\CVPR\PIPAL_288x288\Reference_overall\overview&ori\\'
